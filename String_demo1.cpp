...
/* output of the above program with some sample inputs using CAEN gcc/g++ 4.7.0
caen-vnc04% g++ -std=c++11 String.cpp Utility.cpp String_demo1.cpp
caen-vnc04% ./a.out
...
a_medium_length_string_this_is
String input: String contains "a_medium_length_string_this_is", length is 30, allocation is 46
how_about_a_very_long_string_said_Holmes_as_he_filled_his_pipe_and_eyed_his_violin
